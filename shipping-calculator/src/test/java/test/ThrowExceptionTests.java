...
public class ThrowExceptionTests {
    ...
    public void negativeRange(Double range, DimensionType dimensionType, Boolean isFragile, WorkloadStatus workloadStatus) {
        assertThrows(
    ...
    @CsvSource({
            ...
            "35.0, SMALL, true, INCREASED",
    })
    public void isFragileToRangeGreaterPossible(Double range, DimensionType dimensionType, Boolean isFragile, WorkloadStatus workloadStatus) {
        assertThrows(
